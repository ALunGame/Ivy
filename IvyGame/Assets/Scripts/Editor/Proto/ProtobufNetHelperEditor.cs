...
{
    public const string protobufNetDirRoot = "Assets/Plugins/Proto/";
    public const string protobuf_net_dll_path = "Assets/Plugins/Proto/protobuf-net.dll";
    ...
    private static void RebuildProtobufModelForProject()
    {
        ...
        if (!Directory.Exists(protobufNetDirRoot))
        {
            Directory.CreateDirectory(protobufNetDirRoot);
        }
        File.Copy("protobuf-model.dll", protobufNetDirRoot + "protobuf-model.dll", true);
