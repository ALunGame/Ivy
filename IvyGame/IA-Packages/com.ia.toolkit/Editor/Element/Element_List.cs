...
namespace IAToolkit.Element
{
    ...
    public class Element_List<L, E> : BaseField<L>, INotifyValueChanged<L>, IListField where L : IList<E>
    {
        ...
        public Element_List(string _label, L _list, VisualElement _inputElement) : base(_label, _inputElement)
        {
            foldout = new Foldout();
