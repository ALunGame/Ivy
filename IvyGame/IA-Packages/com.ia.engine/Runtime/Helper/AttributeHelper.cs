...
namespace IAEngine
{
    ...
    public static partial class AttributeHelper
    {
        ...
        public static bool TryGetFieldAttribute<AttributeType>(Type type, string fieldName,
            ...
            where AttributeType : Attribute
        {
            return TryGetFieldAttribute(ReflectionHelper.GetFieldInfo(type, fieldName), out attribute);
        }
        ...
        {
            return GetFieldAttributes(ReflectionHelper.GetFieldInfo(type, fieldName));
        }
        ...
        public static bool TryGetMethodAttribute<AttributeType>(Type type, string _methodName,
            ...
            where AttributeType : Attribute
        {
            return TryGetMethodAttribute(ReflectionHelper.GetMethodInfo(type, _methodName), out _attribute);
        }
        ...
        {
            return GetMethodAttributes(ReflectionHelper.GetMethodInfo(type, _methodName));
        }
